...
class MySymbolRemoteSource @Inject constructor(private val symbolCreationService: SymbolCreationService) {
    ...
    suspend fun createSymbolBackup(
        ...
        flow {
            ...
            val result =
                symbolCreationService.createSymbolBackup(symbolTextPart, categoryIdPart, image)
            emit(result)
        }
}
